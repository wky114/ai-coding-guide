...
**所有这些形态，底层是同一个 Claude Code 引擎。** 也就是说，你写的 `CLAUDE.md`（项目说明文件）、你的配置、你接的 MCP 服务——在终端配好了，换到 VS Code、换到手机上照样生效。**配一次，处处能用。**
...
**但是**，比「能做什么」更重要的，是认清它**不能**做什么。这点菜鸟教程总结得很到位，我照着补充我的体会：
