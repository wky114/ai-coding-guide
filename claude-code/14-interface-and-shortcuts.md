...
说句实话，这是新手最容易搞混的一句话。Claude Code 的界面看着简单，就一个输入框加几行字，**但底下藏着一整套键盘动作和特殊符号，知道的人用得飞起，不知道的人全靠鼠标和回车硬刚**。很多人头两周也是这样，盯着满屏滚动的输出干等了三分钟才想起来「我按个 Esc 不就停了吗」——那一刻是真有点想抽自己。
...
这里有个新手特别容易慌的场景：**屏幕突然变花、或者一半空白了**。别以为崩了。官方给了个专门的键 `Ctrl+L`，强制重绘屏幕，输入和对话历史都保留。常见的情况是在 tmux 里跑 Claude，切窗口回来满屏乱码，看着像会话挂了、想重启，结果一个 `Ctrl+L` 就干净了。
